...
### El p valor da en los tres casos mayor que 0.05, por lo que la relación no es estadísticamente significativa. Además, la correlación, también en los tres casos, es negativa, lo cual indica que no existe una relación positiva ni directamente proporcional.
