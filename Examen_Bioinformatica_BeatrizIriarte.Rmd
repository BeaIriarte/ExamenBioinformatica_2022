...
### El día de mi cumpleaños es el 4 de abril, por lo que el mes seleccionado será el 4 y el día será el 4 también:
...
## El p value obtenido es muy inferior a 0.05, por lo que existen evidencias estadísticamente significativas para afirmar que existe una relación y diferencia significativa entre ambos orígenes y sus temperaturas, en el cuatro de abril. 
...
```
### Se observa una tendencia positiva que confirma la relación significativa hallada en el t.test.
